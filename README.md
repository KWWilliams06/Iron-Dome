...
A Jetson Orin Nano runs a fine-tuned YOLO detector through TensorRT. A Kalman filter predicts target motion to compensate for latency, and an Arduino Nano drives the pan/tilt motors and laser over a serial protocol.
